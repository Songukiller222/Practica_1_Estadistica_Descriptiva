...
tabla_frecuencia_Company <-FastFoodNutritionMenuV2 |>
  ...
  mutate(f = n/nrow(FastFoodNutritionMenuV2),
         N = cumsum(n),
         F = cumsum(f))
knitr::kable(tabla_frecuencia_Company, digits = 4) |> labs(title = "Tabla de frequencia de compañías")
```
...
knitr::kable(tabla_frecuencias_Calories, digits = 4)
```
...
knitr::kable(tabla_frecuencias_Fat, digits = 4)
...
knitr::kable(tabla_frecuencias_Saturated, digits = 4)
...
knitr::kable(tabla_frecuencias_Cholesterol, digits = 4)
```
...
knitr::kable(tabla_frecuencias_Sodium, digits = 4)
```
...
knitr::kable(tabla_frecuencias_Carbs, digits = 4)
...
knitr::kable(tabla_frecuencias_Fiber, digits = 4)
...
FastFoodNutritionMenuV2 |> ggplot(aes(Fiber..g.)) +
  geom_histogram(fill = "cyan", bins = 15, col = "white") + labs(title = "Histograma de las fibra",
...
knitr::kable(tabla_frecuencias_Sugars, digits = 4)
...
knitr::kable(tabla_frecuencias_Protein, digits = 4)
